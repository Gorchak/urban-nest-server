...
const normalizeSale = (data = {}) => {
  ...
  return {
    ...
    payment: {
      ...
      basePaymentAmount: toNumber(data.payment?.basePaymentAmount),
      serviceFee: toNumber(data.payment?.serviceFee),
      chargedAmount: toNumber(data.payment?.chargedAmount),
      balanceDue: toNumber(data.payment?.balanceDue),
    },
    items,
    subtotal,
    discountTotal,
